# -*- coding: utf-8 -*-
"""
Simple launch script for Maya Outliner V2 (no emoji, GBK-safe).
...
Or if encoding parameter doesn't work:
    import sys
    import codecs
...
def main():
    ...
    print("\n" + "=" * 80)
    print("Launching Maya Outliner V2 with Lifecycle Management")
    print("=" * 80 + "\n")
